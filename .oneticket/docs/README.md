...
GitHub-native autonomous multi-agent orchestration framework —
dispatch, fanout, gather, all wired to GitHub issues and pull requests.

No custom platform. No proprietary runtime. Just GitHub Actions, a config file, and agents doing the work.
