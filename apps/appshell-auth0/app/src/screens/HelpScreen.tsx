 ...
 * Contains FAQ and documentation references.
 */
    ...
    <div className="flex-grow bg-background text-foreground py-12 px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8">
          <details className="mb-4 p-4 border border-border rounded cursor-pointer">
          ...
          <details className="mb-4 p-4 border border-border rounded cursor-pointer">
            ...
            <p className="text-muted-foreground text-base mt-4">
              AppShell Auth0 uses localStorage for client-side storage and React Query for
