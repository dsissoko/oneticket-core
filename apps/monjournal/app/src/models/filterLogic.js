 ...
 */
export function matchesTextSearch(thought, query) {
 ...
 */
export function matchesDateRange(thought, startDate, endDate) {
 ...
 */
export function matchesTags(thought, selectedTags) {
 ...
 */
export function matchesAllFilters(thought, filters) {
    // All filters must pass (AND logic)
    return (matchesTextSearch(thought, filters.text) &&
 ...
 */
export function applyFilters(thoughts, filters) {
 ...
 */
export function countMatches(thoughts, filters) {
...
export function hasActiveFilters(filters) {
    return ((filters.text !== undefined && filters.text.trim().length > 0) ||
