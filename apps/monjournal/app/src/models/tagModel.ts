...
/**
 * Represents a tag with its assigned color
 */
export interface Tag {
  /** The tag name (e.g., "work", "personal") */
  name: string;

  /** Hex color string assigned deterministically (e.g., "#FF6B6B") */
  color: string;
}
 ...
 */
export function filterTagsByName(tags: Tag[], names: Set<string>): Tag[] {
