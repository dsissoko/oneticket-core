  ...
  return (
    <div className="flex-grow bg-background text-foreground py-12 px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">SpaceInvaders — Foundation for OneTicket Applications</p>

        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Our Vision</h2>
          <p className="text-base text-muted-foreground mb-4">
            SpaceInvaders is a canonical reference implementation for building modern,
