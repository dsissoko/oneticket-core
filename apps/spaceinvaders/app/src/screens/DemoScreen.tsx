  ...
  return (
    <Card>
      <CardContent className="pt-6 space-y-3">
        ...
        <a
          href="https://dsissoko.github.io/oneticket-core/spaceinvaders/docs/what/epics/epic-1-auth0/epic/"
          target="_blank"
  ...
  return (
    <div className="flex-grow bg-background text-foreground py-12 px-4 sm:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">Interactive showcase of SpaceInvaders patterns.</p>
