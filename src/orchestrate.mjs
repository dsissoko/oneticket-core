 ...
 *
 * v1.0.0:
 *   - createFinalPR removed — PR is a user decision, never auto-created
 *   - branch_base removed — derived from featureBranch locally
 *
 * Expected environment variables:
 *   GITHUB_TOKEN, TASK_BRANCH (e.g. task/issue-42-B), REPO
 */
