...
application, scaffolded from the AppShell template and deployed on GitHub Pages.
...
### Responsive layout
- AppShell scaffold — canvas fills the content area (flex-grow pattern)
...
- Game Over and Victory end screens — rendered on canvas
...
## App scaffold
Initialize the app from the AppShell template — use the `scaffold-appshell` skill.
